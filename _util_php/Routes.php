...
class Routes
{
    ...
    public function getResourceForContainerApp()
    {
        ...
        if ($routes->isURLValidate()) {
            ...
            array_push($list_pages, $resource);
            //CLIENTES INACTIVOS
            $resource = new BeanResource('app/clientes/inactivo', array($path_resource . 'app/cliente/inactivo/cliente.html', $path_resource . 'app/footer/footer.html', $path_resource . 'app/prospecto/alumno_filter.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/cliente/inactivo/cliente.js?v=' . $version_proyect, $path_resource . 'app/prospecto/alumno_filter.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //PERSONAL
            ...
            array_push($list_pages, $resource);
            //CITAS/CRONOGRAMA
            $resource = new BeanResource('app/cita/cronograma', array($path_resource . 'app/cita/cita.html', $path_resource . 'app/cita/config/cita.html', $path_resource . 'app/cita/cronograma/cronograma.html', $path_resource . 'app/footer/footer.html', $path_resource . 'app/libro/curso_c.html', $path_resource . 'app/cita/cita.html', $path_resource . 'app/album/subtitulo_filter.html', $path_resource . 'app/cita/config/alumno_filter.html'), array($path_resource . 'app/cita/cita.js?v=' . $version_proyect, $path_resource . 'app/cita/config/cita.js?v=' . $version_proyect, $path_resource . 'app/cita/cronograma/cronograma.js?v=' . $version_proyect, $path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/libro/curso_c.js?v=' . $version_proyect, $path_resource . 'app/album/subtitulo_filter.js?v=' . $version_proyect, $path_resource . 'app/cita/config/alumno_filter.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //PUBLICOS
    ...
    public function getResourceForContainerApi()
    {
        ...
        if ($routes->isURLValidate()) {
            ...
            array_push($list_pages, $resource);
            //prospecto
            $resource = new BeanResource('api/prospectos', array($path_resource . 'prospectoAjax.php'), array(), array());
            array_push($list_pages, $resource);
