...
class Routes
{
    ...
    public function getResourceForContainerApp()
    {
        ...
        if ($routes->isURLValidate()) {
            ...
            /* ----MODULO DE ALUMNOS---- */
            //INDEX
            $resource = new BeanResource('aula/index', array($path_resource . 'aula/index/index.html', $path_resource . 'aula/notificacion/notificacion.html'), array($path_resource . 'aula/index/index.js?v=' . $version_proyect, $path_resource . 'aula/notificacion/notificacion.js?v=' . $version_proyect, 'plugins/flowplayer/js/flowplayer.min.js', 'plugins/flowplayer/js/flowplayer.hlsjs.light.min.js'), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'aula/notificacion/style.scss?v=' . $version_proyect, 'plugins/video/css/video.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //PERFIL
            $resource = new BeanResource('aula/perfil', array($path_resource . 'aula/perfil/perfil.html'), array($path_resource . 'aula/perfil/perfil.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            /*
            ...
            //RECURSOS
            $resource = new BeanResource('aula/recursos', array($path_resource . 'aula/recurso/recurso.html', $path_resource . 'aula/recurso/detalle/detalle.html'), array($path_resource . 'aula/recurso/recurso.js?v=' . $version_proyect, $path_resource . 'aula/recurso/detalle/detalle.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //LECCIONES REALIZADAS
            $resource = new BeanResource('aula/lecciones', array($path_resource . 'aula/leccion/tarea/tarea.html', $path_resource . 'aula/leccion/leccion.html', $path_resource . 'aula/leccion/respuesta/respuesta.html'), array($path_resource . 'aula/leccion/leccion.js?v=' . $version_proyect, $path_resource . 'aula/leccion/tarea/tarea.js?v=' . $version_proyect, $path_resource . 'aula/leccion/respuesta/respuesta.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, 'plugins/video/css/video.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //MENSAJE
            $resource = new BeanResource('aula/mensajes', array($path_resource . 'aula/mensaje/mensaje.html'), array($path_resource . 'aula/mensaje/mensaje.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //CONFERENCIA
            $resource = new BeanResource('aula/conferencias', array($path_resource . 'aula/conferencia/conferencia.html'), array($path_resource . 'aula/conferencia/conferencia.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'aula/conferencia/style.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            /* ----MODULO DE MANAGER---- */
            //INDEX
            ...
            array_push($list_pages, $resource);
            //CLIENTES ACTIVOS
            $resource = new BeanResource('app/clientes/activo', array($path_resource . 'app/cliente/activo/cliente.html', $path_resource . 'app/footer/footer.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/cliente/activo/cliente.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //CLIENTES INACTIVOS
            ...
            array_push($list_pages, $resource);
            //TEST GENERAL
            $resource = new BeanResource('app/test/general', array($path_resource . 'app/test/general/test.html', $path_resource . 'app/libro/capitulo/capitulo_filter.html', $path_resource . 'app/test/general/subtitulo_filter.html', $path_resource . 'app/footer/footer.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/test/general/test.js?v=' . $version_proyect, $path_resource . 'app/test/general/detalle/detalle.js?v=' . $version_proyect, $path_resource . 'app/test/general/class.js?v=' . $version_proyect, $path_resource . 'app/libro/capitulo/capitulo_filter.js?v=' . $version_proyect, $path_resource . 'app/test/general/subtitulo_filter.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //TEST INTERNO
            $resource = new BeanResource('app/test/interno', array($path_resource . 'app/test/interno/test.html', $path_resource . 'app/test/interno/subtitulo_filter.html', $path_resource . 'app/footer/footer.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/test/interno/test.js?v=' . $version_proyect, $path_resource . 'app/test/interno/class.js?v=' . $version_proyect, $path_resource . 'app/test/interno/detalle/detalle.js?v=' . $version_proyect, $path_resource . 'app/test/interno/subtitulo_filter.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //MENSAJES
            ...
            $resource = new BeanResource('app/album', array($path_resource . 'app/album/album.html', $path_resource . 'app/album/subtitulo_filter.html', $path_resource . 'app/footer/footer.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/album/album.js?v=' . $version_proyect, $path_resource . 'app/album/subtitulo_filter.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //PUBLICOS
            ...
            array_push($list_pages, $resource);
            //CERTIFICADOS
            $resource = new BeanResource('app/certificados', array($path_resource . 'app/certificado/cliente.html', $path_resource . 'app/footer/footer.html'), array($path_resource . 'app/footer/footer.js?v=' . $version_proyect, $path_resource . 'app/certificado/cliente.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //CERTIFICADOS
            ...
            //AUTH
            ///////RECOVERY
            $resource = new BeanResource('auth/recovery', array($path_resource . 'auth/recovery/recovery.html'), array($path_resource . 'auth/recovery/recovery.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            ///////restaurar contraseña email
            $resource = new BeanResource('auth/recovery/verificaty', array($path_resource . 'auth/recovery/verificaty/verificaty.html'), array($path_resource . 'auth/recovery/verificaty/verificaty.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            ///////CODIGO DE VERIFICACION
            $resource = new BeanResource('auth/verification', array($path_resource . 'auth/verificaty/verificaty.html'), array($path_resource . 'auth/verificaty/verificaty.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect));
            array_push($list_pages, $resource);

            ///////SIGNUP
            $resource = new BeanResource('auth/signup-xxx', array($path_resource . 'auth/signup/signup.html'), array($path_resource . 'auth/signup/signup.js?v=' . $version_proyect, $path_resource . 'auth/login/login.html', $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect), array('vistas/publico/Dale/flag-icon-css/css/flag-icon.min.css'));
            array_push($list_pages, $resource);
            //INDEX
            $resource = new BeanResource('index', array($path_resource . 'publico/home/home.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/home/home.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/home/video.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect, 'plugins/video/js/video.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, 'plugins/video/css/video.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, 'plugins/video/css/video.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //INDEX
            $resource = new BeanResource('', array($path_resource . 'publico/home/home.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/home/home.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/home/video.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect, 'plugins/video/js/video.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, 'plugins/video/css/video.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //BLOG
            $resource = new BeanResource('blog', array($path_resource . 'publico/blog/blog.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/blog/blog.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/blog/js/jquery.mousewheel.js?v=' . $version_proyect, $path_resource . 'publico/blog/js/jquery.masonry.min.js?v=' . $version_proyect, $path_resource . 'publico/blog/js/jquery.gpCarousel.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, $path_resource . 'publico/blog/css/style.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //BLOG
            $resource = new BeanResource('blog/detalle/:', array($path_resource . 'publico/blog/comentario/comentario.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/blog/comentario/comentario.js?v=' . $version_proyect, $path_resource . 'publico/blog/comentario/publicidad-detalle.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, 'vistas/publico/Dale/js/owl.carousel.min.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //TESTIMONIOS
            $resource = new BeanResource('testimonios', array($path_resource . 'publico/testimonio/testimonio.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/testimonio/testimonio.js?v=' . $version_proyect, $path_resource . 'publico/testimonio/js/modernizr.custom.63321.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'publico/testimonio/css/style.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //NOSOTROS
            $resource = new BeanResource('nosotros', array($path_resource . 'publico/promotor/promotor.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/promotor/promotor.js?v=' . $version_proyect, $path_resource . 'publico/promotor/video.js?v=' . $version_proyect, $path_resource . 'publico/promotor/js/jquery.gallery.js?v=' . $version_proyect, $path_resource . 'publico/promotor/js/modernizr.custom.53451.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'publico/promotor/css/style.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect));
            array_push($list_pages, $resource);

            //CURSO
            $resource = new BeanResource('matricula', array($path_resource . 'publico/matricula/curso/curso.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/matricula/curso/curso.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect, $path_resource . 'publico/matricula/js/modernizr.custom.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, $path_resource . 'publico/matricula/css/style.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //CURSO DETALLE
            $resource = new BeanResource('matricula/detalle/:', array($path_resource . 'publico/matricula/detalle/detalle.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'publico/matricula/detalle/detalle.js?v=' . $version_proyect, $path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/matricula/js/modernizr.custom.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, $path_resource . 'publico/matricula/css/book.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
            //COMPRAR
            $resource = new BeanResource('comprar', array($path_resource . 'publico/comprar/comprar.html', $path_resource . 'auth/login/login.html', $path_resource . 'auth/register/register.html'), array($path_resource . 'auth/login/login.js?v=' . $version_proyect, $path_resource . 'publico/comprar/comprar.js?v=' . $version_proyect, $path_resource . 'publico/footer/footer.js?v=' . $version_proyect, $path_resource . 'auth/register/register.js?v=' . $version_proyect, $path_resource . 'publico/footer/js/chat.js?v=' . $version_proyect, $path_resource . 'publico/matricula/js/modernizr.custom.js?v=' . $version_proyect), array('css/clpe.css?v=' . $version_proyect, $path_resource . 'auth/login/login.css?v=' . $version_proyect, 'vistas/publico/Dale/flag-icon-css/css/flag-icon.css?v=' . $version_proyect, $path_resource . 'publico/comprar/style.css?v=' . $version_proyect));
            array_push($list_pages, $resource);
