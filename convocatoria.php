...
<head>
    ...
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/styleSocial.css" rel="stylesheet" />
     ...
     <!-- Bootstrap core CSS -->
     <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/bootstrap.min.css?v=0.51" rel="stylesheet" />
    ...
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/lightbox.css" rel="stylesheet" />
     ...
     <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/masterslider/masterslider.css?v=0.51" rel="stylesheet" />
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/masterslider/skins/black-1/style.css?v=0.51" rel="stylesheet" />
    <!-- Primary CSS styles -->
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/style.css?v=0.51" rel="stylesheet" />
    <?php

$beanResource = $routes->getResourceForContainerConvocatoriaApp();
    ...
    <div class="dt-root">
        <div class="dt-root__inner">
            ...
            <div class="container-wrapper navigation">
               <h2 class=" text-center w-100">  <a class="text-white"  href="<?php echo (SERVERURL . 'index'); ?>" >CLUB DE LECTURA PARA EMPRENDEDORES</a></h2>
...
?>
    ...
    <script language="javascript" src="<?php echo SERVERURL; ?>vistas/publico/js/bootstrap.min.js?v=0.51"></script>
    <script src="<?php echo SERVERURL; ?>vistas/js/sweet-alert.min.js?v=0.51"></script>

    <script type="text/javascript"  src="<?php echo (SERVERURL); ?>plugins/sticky/stickybits.min.js?v=0.51"></script>

    <!-- scrip EDIT -->
    <script type="text/javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/functions.js?v=0.51"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/configuration_api.js?v=0.51"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/functions_operational.js?v=0.51"></script>
    ...
    <script type="text/javascript"
        src="<?php echo (SERVERURL); ?>vistas/scripts/session/session.validate.login.js?v=0.51"></script>
