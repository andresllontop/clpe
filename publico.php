...
<head>
    ...
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/styleSocial.css" rel="stylesheet" />
     ...
     <!-- Bootstrap core CSS -->
     <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/bootstrap.min.css?v=o.52" rel="stylesheet" />
    ...
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/lightbox.css" rel="stylesheet" />
     ...
     <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/masterslider/masterslider.css?v=o.52" rel="stylesheet" />
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/masterslider/skins/black-1/style.css?v=o.52" rel="stylesheet" />
    <!-- Primary CSS styles -->
    <link href="<?php echo SERVERURL; ?>vistas/publico/Dale/css/style.css?v=o.52" rel="stylesheet" />
    <?php
...
?>
  ...
  logged_out_greeting="Hola soy el administrador del CLPE ¿En que puedo ayudarte?">
    ...
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/jquery-1.11.0.min.js?v=o.52"></script>


    <!-- Waypoints core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/waypoints.min.js?v=o.52"></script>
    <!-- Underscore core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/underscore-min.js?v=o.52"></script>

    <!-- jQuery color core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/jquery.animation.js?v=o.52"></script>

    <!-- Stellar Matricula core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/jquery.stellar.min.js?v=o.52"></script>

    <!-- Nivo Matricula Slider JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/jquery.nivo.slider.pack.js?v=o.52"></script>
    <!-- Video core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/jquery.easing.1.3.js?v=o.52"></script>
    <!-- Video core JavaScript -->


    <!-- REDES SOCIALES core JavaScript -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/functions.js?v=o.52"></script>
    <!-- Everything else -->
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/custom.js?v=o.52"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/publico/Dale/js/main.js?v=o.52"></script>
    <!-- scrip API -->
    <!-- Bootstrap core JavaScript -->
    <script language="javascript" src="<?php echo SERVERURL; ?>vistas/publico/js/bootstrap.min.js?v=o.52"></script>
    <script src="<?php echo SERVERURL; ?>vistas/js/sweet-alert.min.js?v=o.52"></script>

    <script type="text/javascript"  src="<?php echo (SERVERURL); ?>plugins/sticky/stickybits.min.js?v=o.52"></script>

    <!-- scrip EDIT -->
    <script type="text/javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/functions.js?v=o.52"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/configuration_api.js?v=o.52"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/util/functions_operational.js?v=o.52"></script>
    <script type="text/javascript"
    src="<?php echo (SERVERURL); ?>vistas/scripts/util/functions_alerts.js?v=0.39"></script>
    <script language="javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/init_parameters.js?v=o.52"></script>
    <!--Scripts -->
    <script type="text/javascript" src="<?php echo (SERVERURL); ?>vistas/scripts/session/js.cookie.js?v=o.52"></script>
    <script type="text/javascript"
        src="<?php echo (SERVERURL); ?>vistas/scripts/session/session.validate.login.js?v=o.52"></script>
