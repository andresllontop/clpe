...
define("VISA_CURRENCY", "USD");

///Apitest
define('VISA_DEV_MERCHANT_ID', '456879853');
...
define('VISA_PRD_URL_TOKENIZATION', 'https://apiprod.vnforapps.com/api.ecommerce/v2/ecommerce/token/card/' . VISA_PRD_MERCHANT_ID . '/');
