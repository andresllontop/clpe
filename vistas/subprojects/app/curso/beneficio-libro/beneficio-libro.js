...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector("#tipoOpcionHeaderCurso").innerHTML = "Beneficios del Libro";
    ...
    $("#btnAbrirbook").click(function () {
        ...
        $("#imagePreview").html("");
        $("#tituloModalManPregunta").html("REGISTRAR BENEFICIO DEL LIBRO");
        addPregunta();
...
function processAjaxPregunta() {
    ...
    switch (beanRequestPregunta.operation) {
        case 'delete':
            ...
            break;
        case 'curso':
            parameters_pagination = '?idcurso=' + curso_cSelected.idcurso + '&tipo=2';
            break;
        case 'update':
...
function listaPregunta(beanPagination) {
    ...
    document.querySelector('#titleManagerPregunta').innerHTML =
        '[ ' + beanPagination.countFilter + ' ]  BENEFICIOS DEL LIBRO';
    let contador = 1, row = "";
...
<td class="text-center" >${pregunta.detalle}</td>
    ...
    document.querySelectorAll('.editar-pregunta').forEach((btn) => {
        ...
        btn.onclick = function () {
            ...
            if (preguntaSelected != undefined) {
                ...
                $("#tituloModalManPregunta").html("EDITAR BENEFICIO DEL LIBRO");
                $("#ventanaModalManPregunta").modal("show");
                beanRequestPregunta.type_request = 'POST';
                beanRequestPregunta.operation = 'update';
            } else {
