...
function processAjaxCurso() {
    ...
    switch (beanRequestCurso.operation) {
        ...
        case 'update':
            ...
            if (document.querySelector("#txtImagenPresentacionCurso").files.length !== 0) {
                let dataPresentacion = $("#txtImagenPresentacionCurso").prop("files")[0];
    ...
    $.ajax({
        ...
        data: form_data,
        cache: false,
        contentType: ((beanRequestCurso.operation == 'update' || beanRequestCurso.operation == 'add') ? false : 'application/json; charset=UTF-8'),
        processData: false,
        dataType: 'json',
...
function addCurso(curso = undefined) {
    ...
    document.querySelector('#txtTituloCurso').value = (curso == undefined) ? '' : curso.titulo;
    document.querySelector('#txtTipoCurso').value = (curso == undefined) ? '0' : curso.tipo;
    document.querySelector('#txtDescripcionCurso').value = (curso == undefined) ? '' : curso.descripcion;
    document.querySelector('#txtDescuentoCurso').value = (curso == undefined) ? '' : curso.descuento;
    document.querySelector('#txtPrecioCurso').value = (curso == undefined) ? '' : curso.precio;


    if (curso != undefined) {
        document.querySelector("#imagenPreview").innerHTML = "<img width='244' alt='user-picture' class='img-responsive center-box' src='" +
            getHostFrontEnd() + 'adjuntos/libros/' + curso.imagen +
            "' />";
        document.querySelector("#imagenPortadaPreview").innerHTML = "<img width='244' alt='user-picture' class='img-responsive center-box' src='" +
            getHostFrontEnd() + 'adjuntos/libros/' + curso.portada +
            "' />";
        document.querySelector("#imagenPresentacionPreview").innerHTML = "<img width='244' alt='user-picture' class='img-responsive center-box' src='" +
            getHostFrontEnd() + 'adjuntos/libros/' + curso.presentacion +
            "' />";
...
<td class="text-center">${curso.tipo == 1 ? "CURSO ONLINE" : "CURSO POR ZOOM"}</td>
...
function findIndexCurso(idbusqueda) {
    return beanPaginationCurso.list.findIndex(
        (Curso) => {
            if (Curso.idcurso == parseInt(idbusqueda))
                return Curso;
...
function findByCurso(idcurso) {
    return beanPaginationCurso.list.find(
        (Curso) => {
...
var validateFormCurso = () => {
    ...
    if (beanRequestCurso.operation == 'add') {
        ...
        if (!(document.querySelector("#txtImagenCurso").files[0].type == "image/png" || document.querySelector("#txtImagenCurso").files[0].type == "image/jpg" || document.querySelector("#txtImagenCurso").files[0].type == "image/jpeg")) {
            swal({
        ...
        //menor a   4 MB
        if (document.querySelector("#txtImagenCurso").files[0].size > (4 * 1024 * 1024)) {
            swal({
        ...
        if (!(document.querySelector("#txtImagenPortadaCurso").files[0].type == "image/png" || document.querySelector("#txtImagenPortadaCurso").files[0].type == "image/jpg" || document.querySelector("#txtImagenPortadaCurso").files[0].type == "image/jpeg")) {
            swal({
                title: "Formato Incorrecto",
        ...
        //menor a   4 MB
        if (document.querySelector("#txtImagenPortadaCurso").files[0].size > (4 * 1024 * 1024)) {
            swal({
                title: "Tamaño excedido",
        ...
        if (!(document.querySelector("#txtImagenPresentacionCurso").files[0].type == "image/png" || document.querySelector("#txtImagenPresentacionCurso").files[0].type == "image/jpg" || document.querySelector("#txtImagenPresentacionCurso").files[0].type == "image/jpeg")) {
            swal({
                title: "Formato Incorrecto",
        ...
        //menor a   4 MB
        if (document.querySelector("#txtImagenPresentacionCurso").files[0].size > (4 * 1024 * 1024)) {
            swal({
                title: "Tamaño excedido",
        ...
        if (document.querySelector("#txtImagenCurso").files.length != 0) {
            ...
            //menor a   4 mb
            if (document.querySelector("#txtImagenCurso").files[0].size > (1700 * 1024)) {
                swal({
                    title: "Tamaño excedido",
        ...
        if (document.querySelector("#txtImagenPortadaCurso").files.length != 0) {
            ...
            //menor a   4 mb
            if (document.querySelector("#txtImagenPortadaCurso").files[0].size > (1700 * 1024)) {
                swal({
                    title: "Tamaño excedido",
        ...
        if (document.querySelector("#txtImagenPresentacionCurso").files.length != 0) {
            ...
            //menor a   4 mb
            if (document.querySelector("#txtImagenPresentacionCurso").files[0].size > (1700 * 1024)) {
                swal({
                    title: "Tamaño excedido",
