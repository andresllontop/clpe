$(document).ready(function () {
    ...
    $(".FormularioAjax").submit(function (e) {
        ...
        formdata.append("Ubicacion-reg", 2);
    ...
    function listar(paginas, registrototal) {
        $.ajax({
          ...
          <td class="text-center" style="width:200px;height:120px;">${
                                    videos[key].enlace
                                    }</td>
    ...
    //       break;
    //     case "2":
    //       dato = "Vista Testimonios";
    //       break;
    //     case "3":
    //       dato = "Vista Promotores";
    //       break;
    //     case "4":
    //       dato = "Vista Nosotros";
    //       break;
