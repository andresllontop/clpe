$(document).ready(function () {
    ...
    $("#btnAbrirbook").click(function () {
        ...
        $("#tituloModalManlibro").html("REGISTRAR TESTIMONIO");
            ...
            success: function (respuesta) {
                ...
                if (respuesta == "ninguno") {
                    ...
                    for (let key in videos) {
                        contador++;
                        html += `<tr numero="${contador}" id="${videos[key].idtestimonio}" >
          <td class="text-center ">${contador}</td>
          <td class="text-center">${videos[key].titulo}</td>
          <td class="text-center" style="height:100px;">${videos[key].descripcion.substring(0, 700)}</td>
          <td class="text-center">${videos[key].enlaceYoutube}</td>
          <td  class="text-center "><img 
            src="${url}adjuntos/testimonio/${videos[key].imagen}"
            alt="user-picture"
            class="img-responsive center-box" style="width:100px;height:90px;"
        ...
        $(".editar-Admin").each(function (index, value) {
            $(this).click(function () {
                ...
                $("#Descripcion-reg").Editor("setText", [
                    '<p style="color:black">' + rowvalue[indice - 1][2] + "</p>"
                ]);
                ...
                $("#tituloModalManlibro").html("EDITAR TESTIMONIO");
                $("#ventanaModalManlibro").modal("show");
            });
        });
